package com.playxcodes.aprendaingles.fragments;
...
import com.playxcodes.aprendaingles.R;
...
public class BichosFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       buttonCao.setOnClickListener(this);  //nossa propria classe vai tratar dos cliques do usuario
    ...
    public void onClick(View view) {
        // Log.i("Elementos clicado", "Item: " + view.getId());
    ...
    public void tocarSom(){
        if (mediaPlayer != null){
            ...
            //fazer um tratamento quando o som é finalizado
            mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
                public void onCompletion(MediaPlayer mp) {
                    mediaPlayer.release(); //liberar os recursos
                }
            });
